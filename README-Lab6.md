...
1. **cppcheck** — анализатор качества кода (бесплатный, простой в использовании)
2. **PVS-Studio** — анализатор безопасности (как в примере, выявляет ошибки и уязвимости)
3. **Trufflehog** — поиск секретов в репозитории
